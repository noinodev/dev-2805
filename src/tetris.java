...
class tetris { // main gameplay scene, i put it in its own class file because its huge. i couldve separated it into other classes but i dont really care
    ...
    private final BufferedImage levelimage = main.loadTexture("resources/load/levelatlas.png");
    ...
    public tetris(Tetris2805 m, D2D d) { // this is really gross
        super(m, d);
        draw.clearColour = new Color(24,20,37);
        main.sceneIndex = 4;
        tetrominoList = getTetrominoes(main.loadTexture("resources/load/tetrominoatlas.png"));
